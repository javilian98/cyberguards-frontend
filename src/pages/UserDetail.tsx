            ...
            <div className="grid grid-cols-2 gap-4">
                <Card>
                    ...
                    <CardContent>
                        {/* Table for log data */}
                        <Table>
                            <TableCaption>Employee's log history with risk assessments.</TableCaption>
                            <TableHeader>
                                <TableRow>
                    ...
                    <CardContent>
                        <div className="relative">
                            <div className="flex justify-between">
                                <div>
                                <h2 className="text-center" style={{ fontWeight: 'bold' }}>After Hour Login</h2>
                            ...
                            <div className="details">
                                ...
                                <p><a href={detailInfo.lastWebsiteVisit}>{detailInfo.lastWebsiteVisit}</a></p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
